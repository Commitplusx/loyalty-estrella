...
class PremiumBottomSheet {
  ...
  static Future<T?> showCustom<T>(
    ...
    return showModalBottomSheet<T>(
      ...
      backgroundColor: Colors.transparent,
      builder: (ctx) {
        final actualBg = backgroundColor ?? Theme.of(context).cardTheme.color ?? cs.surface;
        final textColor = (actualBg == Colors.white) ? Colors.black87 : cs.onSurface;
...
class _PremiumToastWidget extends StatefulWidget {
  ...
  const _PremiumToastWidget({required this.title, this.description, required this.isError, required this.icon, required this.onClose, this.onTap});
