...
class GastosScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton.extended(
          onPressed: () => _agregarGasto(context, ref),
          icon: Icon(Icons.add_rounded, color: Colors.white),
          backgroundColor: const Color(0xFFE11D48),
          label: Text('Subir Ticket', style: const TextStyle(color: Colors.white)),
        ),
      ),
  ...
  Future<void> _agregarGasto(BuildContext context, WidgetRef ref) async {
    ...
    List<Map<String, dynamic>> visibleReps = [];
    List<Map<String, dynamic>> visibleMotos = [];
