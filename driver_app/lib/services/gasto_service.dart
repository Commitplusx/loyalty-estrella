...
class GastoService {
  ...
  Future<bool> addGasto(String concepto, double monto, {String? motoId, String? repartidorId, String tipoGasto = 'otro', String? comprobanteUrl, String categoria = 'flota'}) async {
    try {
      final payload = {
