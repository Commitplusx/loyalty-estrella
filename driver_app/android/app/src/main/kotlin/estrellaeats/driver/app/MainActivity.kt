package estrellaeats.driver.app
...
class MainActivity: FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: io.flutter.embedding.engine.FlutterEngine) {
        ...
        io.flutter.plugin.common.MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "estrellaeats.driver.app/permissions").setMethodCallHandler { call, result ->
