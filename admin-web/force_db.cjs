...
async function fix() {
  await supabase.from('pedidos').update({ estado: 'ofrecido', repartidor_id: 'a93fd643-d72d-4e62-b46d-9f2924296ecc' }).eq('id', '0fe600bf-b071-42c7-a0bf-3dcea73ca747');
  console.log('Forced order to ofrecido');
}
fix();
